...
import FizioterapijaHrbtPage from "./pages/fizioterapija/FizioterapijaHrbtPage";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/fizioterapija/fizioterapija-hrbtenica" element={<FizioterapijaHrbtPage />} />
