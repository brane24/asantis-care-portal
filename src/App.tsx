...
import DomenHostnikPage from "./pages/ekipa/DomenHostnikPage";
...
import ZobniPlusPage from "./pages/paketi/ZobniPlusPage";
import FreeMovePage from "./pages/paketi/FreeMovePage";
...
import MenCarePage from "./pages/paketi/MenCarePage";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/ekipa/domen-hostnik" element={<DomenHostnikPage />} />
          ...
          <Route path="/paketi/zobni-plus" element={<ZobniPlusPage />} />
          <Route path="/paketi/freemove" element={<FreeMovePage />} />
          ...
          <Route path="/paketi/mencare-360" element={<MenCarePage />} />
