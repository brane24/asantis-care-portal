      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <CardContent className="pt-6">
                <div className="space-y-3 mb-8">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Mesečni tretma</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span>Vitality modul</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span>Letna analiza biološke starosti</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span><strong>VIP posegi: -50%</strong> (1× / 3 mesece)</span>
                  </div>
                </div>
                <Button size="lg" asChild className="w-full">
                  <NavLink to="/kontakt">
                    Izberi paket <ArrowRight className="ml-2 h-5 w-5" />
                  </NavLink>
                </Button>
              </CardContent>
            </Card>
            ...
            {/* Premium Package */}
            <Card className="border-primary/30 shadow-soft relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <Badge className="bg-primary text-primary-foreground">Priporočeno</Badge>
              </div>
              <CardHeader className="text-center pb-2">
              ...
              <CardContent className="pt-6">
                <div className="space-y-3 mb-8">
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span><strong>Močnejši</strong> mesečni tretma (ali dražji meni)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span><strong>Več</strong> coachinga</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span>Letna analiza biološke starosti</span>
