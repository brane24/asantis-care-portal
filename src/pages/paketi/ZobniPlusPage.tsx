...
const ZobniPlusPage = () => {
  const faqItems = [{
    question: "Ali lahko po preventivnem pregledu prekličem?",
  ...
  const serviceSchema = {
    ...
    "offers": [{
      ...
      "price": "149",
      "priceCurrency": "EUR",
      "description": "Enkraten preventivni pregled z pregledom, RTG/CT, 3D skenom in načrtom zdravljenja"
    }, {
      "@type": "Offer",
  ...
  return <Layout>
      <Helmet>
        ...
        <meta name="description" content="Zobni Plus je preventivni zobni paket z začetno diagnostiko in mesečno naročnino. Preventivni pregled 149 €, mesečno 29 €. Vključeno 1× letno čiščenje zobnega kamna (po indikaciji), aktivno opominjanje ter stalni −15 % članski popust na vse storitve." />
          ...
          <div className="mx-auto max-w-4xl text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                ...
                <span>Preventivni pregled: pregled + CT/RTG + 3D sken + načrt</span>
              </div>
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                <CheckCircle className="h-5 w-5 text-primary" />
        ...
        <div className="container">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">
              Enkraten preventivni pregled
            </Badge>
            <h2 className="text-2xl md:text-4xl font-bold mb-4">
              Kaj vključuje preventivni pregled?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <Card className="hover:shadow-soft transition-all duration-300 border-primary/20 md:col-span-2 lg:col-span-2">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="text-lg">Preventivni pregled članstva</CardTitle>
              </CardHeader>
              <CardContent className="text-center text-muted-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="border-primary/30 bg-primary/5">
            ...
            <CardContent>
              <ul className="space-y-3">
                <li className="flex justify-between">
                  <span className="text-muted-foreground">Preventivni pregled</span>
          ...
          <Card className="bg-muted/30 border-muted">
            <CardContent className="p-6">
              ...
              <ol className="text-sm text-muted-foreground space-y-2 list-decimal list-inside">
                ...
                <li>Cena preventivnega pregleda 149 € se plača ob prvem obisku in ni vračljiva.</li>
        ...
        <Card className="bg-gradient-hero border-primary/20 max-w-4xl mx-auto">
          <CardContent className="p-8 md:p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Preventivni pregled vključuje vse, kar potrebujete za celostni začetek. 
